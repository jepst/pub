...
The \textt{go} function is defined in two parts: one, on line \ref{c_master}, defines the behaviour of the node designated as master, while the other, on line \ref{c_slave}, defines the behaviour of the node designated as worker. 
