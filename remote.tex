...
One can see an analogy between the \textt{expect} function and its channel-based counterpart, \textt{receiveChan}: both receive one message of known type. Where, then, is the analogous 
