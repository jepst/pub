...
data CounterMessage = CounterQuery ProcessId %\label{c_type}
                    ...
                    | CounterIncrement 
                    deriving (Typeable)
instance Binary CounterMessage where
